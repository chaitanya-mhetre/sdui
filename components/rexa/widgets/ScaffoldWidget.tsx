...
function ScaffoldWidgetComponent({ node, renderChild }: ScaffoldWidgetProps) {
  const appBar = node.appBar as RexaLayoutNode | undefined;
  const body = node.body as RexaLayoutNode | undefined;
  const fab = node.floatingActionButton as RexaLayoutNode | undefined;
  const bottomNav = node.bottomNavigation as RexaLayoutNode | undefined;
