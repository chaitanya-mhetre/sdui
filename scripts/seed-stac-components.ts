...
async function seedStacComponents() {
  try {
    console.log('🌱 Starting components seed...');
    ...
    console.log(`\n✅ Successfully seeded ${results.length} components!`);
    console.log('\n📊 Summary:');
    results.forEach((r) => {
      console.log(`   ${r.action === 'created' ? '✅' : '🔄'} ${r.component} (${r.action})`);
    });
