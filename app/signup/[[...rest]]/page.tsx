...
export default function SignupPage() {
  ...
  // Don't render SignUp if already signed in (will redirect)
  if (isSignedIn) {
    return null;
  }
      ...
      <div className="hidden lg:flex flex-col justify-between p-12 w-1/2 bg-gradient-to-br from-primary/10 via-background to-background border-r border-border">
        ...
        <div className="max-w-md space-y-6">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Create beautiful, responsive interfaces with our drag-and-drop builder.
          ...
          <div className="space-y-3 pt-4">
            <div className="flex items-center gap-3 text-sm">
              ...
              <span className="text-muted-foreground">Drag & drop component builder</span>
            </div>
            <div className="flex items-center gap-3 text-sm">
              <div className="w-1.5 h-1.5 rounded-full bg-primary"></div>
              <span className="text-muted-foreground">Real-time preview & versioning</span>
            </div>
            <div className="flex items-center gap-3 text-sm">
              <div className="w-1.5 h-1.5 rounded-full bg-primary"></div>
              <span className="text-muted-foreground">Export to React, Flutter & more</span>
            </div>
          </div>
        </div>

        <div className="text-sm text-muted-foreground">
          <p>Join thousands of developers building with BuildUI</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8 lg:hidden">
            ...
            <p className="text-muted-foreground">Create your BuildUI account</p>
          </div>

          {/* Desktop Header */}
          <div className="hidden lg:block mb-8">
            <h1 className="text-3xl font-bold mb-2">Create your account</h1>
            <p className="text-muted-foreground">Sign up to start building amazing UIs</p>
          </div>
