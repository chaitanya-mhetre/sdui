...
import { ArrowLeft, Sparkles, Globe, Cpu, Workflow } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-[#050506] flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <span className="text-[10px] font-black uppercase tracking-[0.4em] text-emerald-500/60">Initializing_Protocol...</span>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-[#050506] text-white selection:bg-emerald-500/30 grain-texture overflow-hidden flex font-sans">
      ...
      <div className="hidden lg:flex flex-col justify-between p-16 w-[45%] border-r border-white/[0.08] relative z-10 bg-black/20 backdrop-blur-sm">
        ...
        <div className="max-w-md space-y-12">
          <div className="space-y-6">
            ...
            <h2 className="text-5xl font-black leading-[1.1] uppercase tracking-tight">
              Join the<br />
              <span className="text-emerald-500">Distribution Cluster</span>
            </h2>
            <p className="text-zinc-400 text-lg font-medium leading-relaxed">
              Create your account to start orchestration of server-driven layouts across your entire enterprise infrastructure.
            </p>
          </div>

          <div className="space-y-6 pt-8">
            {[
              { icon: Globe, text: "Global Node Deployment" },
              { icon: Cpu, text: "Native Rendering Engine" },
              { icon: Workflow, text: "Schema Logic Orchestration" }
            ].map((item, i) => (
        ...
        <div className="text-[10px] font-black uppercase tracking-[0.4em] text-zinc-600">
          <p>SDUI INDUSTRIAL // REGISTRY OPEN</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 lg:p-12 relative z-10">
        <div className="w-full max-w-md">
          <div className="lg:hidden mb-12 flex flex-col items-center">
            ...
            <h1 className="text-3xl font-black uppercase tracking-tighter text-center">Join Cluster</h1>
          </div>
