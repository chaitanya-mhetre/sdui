...
export default function SignupPage() {
  ...
  return (
    <div className="signup-page relative min-h-screen bg-zinc-950 flex flex-col items-center justify-center p-4">
      <Link
        href="/"
      ...
      <div className="w-full max-w-sm flex flex-col items-center gap-4">
        <div className="text-center">
          <h1 className="text-zinc-100 text-xl font-semibold">Sign up for SDUI</h1>
